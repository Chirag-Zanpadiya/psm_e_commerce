...
const OrderData = ({
  ...
  const handleDownloadInvoice = async () => {
    try {
      ...
      page.drawText("ZCATechX", {
        x: 400,
        y: 750,
        size: 12,
        color: rgb(1, 1, 1),
      });
      page.drawText("PSM100 Villa ", { x: 400, y: 735, size: 10 });
    ...
    <Card className="grid gap-2 p-2">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center">
        ...
        <span
          ...
          className="hover:underline text-sm cursor-pointer flex items-center gap-1 dark:text-[#edcf5d]"
        >
