...
const cartSlice = createSlice({
  ...
  reducers: {
    addToCart: (state, action) => {
      ...
      //   ye feature basically same item do bar purchase karge toh
      // sirf queantity increase honi chahiye naki dubara product show ho hame
    ...
    removeFromCart: (state, action) => {
      ...
      // agar wo index wali item mili hi nahi toh kaise remove kar sakata hu bhai
      if (existingItemIndex === -1) {
        return;
      }
